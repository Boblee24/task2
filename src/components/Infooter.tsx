    ...
    return (
        <div className='w-full p-[.9rem] bg-white'>
            ...
            <div className='flex justify-between md:justify-around'>
                <div>
                    <h4 className='text-[#DA291C] text-[1rem] mb-3 font-semibold'>Quick Links</h4>
                ...
                <div>
                    <h4 className='text-[#DA291C] mb-3 text-[1rem] font-semibold'>Site Links</h4>
                ...
                <div>
                    <h4 className='text-[#DA291C] text-[.9rem] mb-4 '>Download Mobile App</h4>
            ...
            <div className='flex justify-between my-[2rem] md:justify-start md:gap-[30%]'>
                ...
                <div>
                    <p className='text-[.7rem] md:text-[.9rem] text-[#DA291C]'>If you need any help, contact self-help  on +2349139965381</p>
